...
contract E5 {
    ...
    event e2/* Withdraw */( uint256 indexed p1/* sender_account_id */, address indexed p2/* receiver_address */, uint256 p3/* amount */, uint256 p4/* timestamp */, uint256 p5/* block_number */ );
    ...
    function f145(address p1/* withdraw_target */, uint256[2] calldata p2/* t_limits */) external {
        ...
        f143/* transaction_start */(p2/* t_limits */);
        ...
        (bool v3/* sent */, ) = payable(p1/* withdraw_target */).call{value: v2/* amount */}(""); //send them their wei
        require(v3/* sent */, ""/* failed to send requested wei */);
        f144/* transaction_end */();

        emit e2/* Withdraw */(v1/* sender_acc */, p1/* withdraw_target */, v2/* amount */, block.timestamp, block.number);
    }//-----TEST_OK-----
    ...
    function f225(E3.TD/* TransactionData */ memory p1/* tx_data */) private returns (uint256) {
        /* 
            0[<0>transaction_id(10000 - entity_contruction), <1>0, <2>0, <3>context, <4>0, <5>fail_if_duplicate_exists(1 if true), <6>0, <7>0, <8>0, <9>object_type, <10>create_next_pos]
        */
        ...
        if (v2/* acc_obj_id_add_int */[v1/* new_address */] == 0) {
            // E33.f91/* make_account */(v1/* new_address */, p1/* tx_data */.sv7/* new_obj_id */, gv6/* num_data */);
            ...
            //context, as in the invite bucket object for sender used
    ...
    // ------------------------VIEW_FUNCTIONS-------------------------------
    /* get_balance */
    // function f147() public view returns (uint256) {
